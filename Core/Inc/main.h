...
/* Private defines -----------------------------------------------------------*/
#define BTT_ON_Pin GPIO_PIN_0
#define BTT_ON_GPIO_Port GPIOA
#define nFautl_Pin GPIO_PIN_2
#define nFautl_GPIO_Port GPIOB
